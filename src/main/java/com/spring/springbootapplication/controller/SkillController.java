...
public class SkillController {
    ...
    public SkillController(CategoryRepository categoryRepository, UserRepository userRepository, LearningDataRepository learningDataRepository) {
    ...
    // API: ユーザー一覧（JSON）
    @GetMapping("/skill/api/learningDatas")
    @ResponseBody
    public List<LearningData> apiLearningDatas() {
        return learningDataRepository.findAll();
    }
}